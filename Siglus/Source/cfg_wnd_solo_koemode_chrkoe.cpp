...
#define		REGIST_WINDOW_NAME		_T("cfg_wnd_solo_koemode_chrkoe")

// 初期化
void Ccfg_wnd_solo_koemode_chrkoe::init()
{
	regist(REGIST_WINDOW_NAME, true, true, LCL_IDD_CFG_WIN_SOLO_COMMON);
}

// 初期化
bool Ccfg_wnd_solo_koemode_chrkoe::on_init_func()
{
	cfg_wnd_func_koemode.on_init_func(this, CFG_WND_FUNC_MOD_SOLO_KOEMODE_CHRKOE, false, false, false);
	cfg_wnd_func_chrkoe.on_init_func(this, CFG_WND_FUNC_MOD_SOLO_KOEMODE_CHRKOE, false, false, false);
	return true;
}

// 閉じる
bool Ccfg_wnd_solo_koemode_chrkoe::on_close_func()
{
...
// コマンド
bool Ccfg_wnd_solo_koemode_chrkoe::on_command(WPARAM wp, LPARAM lp)
{
...
// 通知
bool Ccfg_wnd_solo_koemode_chrkoe::on_notify(WPARAM wp, LPARAM lp)
{
...
// マウスホイール
bool Ccfg_wnd_solo_koemode_chrkoe::on_mousewheel(WPARAM wp, LPARAM lp)
{
...
// Ｈスクロール
bool Ccfg_wnd_solo_koemode_chrkoe::on_h_scroll(WPARAM wp, LPARAM lp)
{
...
// Ｖスクロール
bool Ccfg_wnd_solo_koemode_chrkoe::on_v_scroll(WPARAM wp, LPARAM lp)
{
...
// スタティックコントロールのカラー変更
LRESULT Ccfg_wnd_solo_koemode_chrkoe::on_ctlcolorstatic(WPARAM wp, LPARAM lp)
{
	LRESULT res;
...
// フレーム
void Ccfg_wnd_solo_koemode_chrkoe::frame_func()
{
	if (!m_h_wnd)	{	return;	}
