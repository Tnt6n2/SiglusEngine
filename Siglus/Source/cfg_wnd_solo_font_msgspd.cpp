...
#define		REGIST_WINDOW_NAME		_T("cfg_wnd_solo_font_msgspd")

// 初期化
void C_cfg_wnd_solo_font_msgspd::init()
{
	regist(REGIST_WINDOW_NAME, true, true, LCL_IDD_CFG_WIN_SOLO_COMMON);
}

// 初期化
bool C_cfg_wnd_solo_font_msgspd::on_init_func()
{
	cfg_wnd_func_font.on_init_func(this, CFG_WND_FUNC_MOD_SOLO_FONT_MSGSPD, false, false, false);
	cfg_wnd_func_msgspd.on_init_func(this, CFG_WND_FUNC_MOD_SOLO_FONT_MSGSPD, false, false, false);
	return true;
}

// 閉じる
bool C_cfg_wnd_solo_font_msgspd::on_close_func()
{
...
// コマンド
bool C_cfg_wnd_solo_font_msgspd::on_command(WPARAM wp, LPARAM lp)
{
...
// 通知
bool C_cfg_wnd_solo_font_msgspd::on_notify(WPARAM wp, LPARAM lp)
{
...
// マウスホイール
bool C_cfg_wnd_solo_font_msgspd::on_mousewheel(WPARAM wp, LPARAM lp)
{
...
// Ｈスクロール
bool C_cfg_wnd_solo_font_msgspd::on_h_scroll(WPARAM wp, LPARAM lp)
{
...
// Ｖスクロール
bool C_cfg_wnd_solo_font_msgspd::on_v_scroll(WPARAM wp, LPARAM lp)
{
...
// スタティックコントロールのカラー変更
LRESULT C_cfg_wnd_solo_font_msgspd::on_ctlcolorstatic(WPARAM wp, LPARAM lp)
{
	LRESULT res;
...
// フレーム
void C_cfg_wnd_solo_font_msgspd::frame_func()
{
	if (!m_h_wnd)	{	return;	}
