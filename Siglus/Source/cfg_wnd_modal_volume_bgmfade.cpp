...
#define		REGIST_WINDOW_NAME		_T("cfg_wnd_modal_volume_bgmfade")

// オープンモーダルファンクション
void Ccfg_wnd_modal_volume_bgmfade::open_modal_func(HWND parent_h_wnd)
{
	create(LCL_IDD_CFG_WIN_SOLO_COMMON, REGIST_WINDOW_NAME, true, parent_h_wnd);
}

// 初期化
bool Ccfg_wnd_modal_volume_bgmfade::on_init_func()
{
	cfg_wnd_func_volume.on_init_func(this, CFG_WND_FUNC_MOD_SOLO_VOLUME_BGMFADE, false, false, true);
	cfg_wnd_func_bgmfade.on_init_func(this, CFG_WND_FUNC_MOD_SOLO_VOLUME_BGMFADE, false, false, true);
	return true;
}

// 閉じる
bool Ccfg_wnd_modal_volume_bgmfade::on_close_func()
{
...
// コマンド
bool Ccfg_wnd_modal_volume_bgmfade::on_command(WPARAM wp, LPARAM lp)
{
...
// タイマー
bool Ccfg_wnd_modal_volume_bgmfade::on_timer_func(WPARAM wp, LPARAM lp)
{
...
// 通知
bool Ccfg_wnd_modal_volume_bgmfade::on_notify(WPARAM wp, LPARAM lp)
{
...
// マウスホイール
bool Ccfg_wnd_modal_volume_bgmfade::on_mousewheel(WPARAM wp, LPARAM lp)
{
...
// Ｈスクロール
bool Ccfg_wnd_modal_volume_bgmfade::on_h_scroll(WPARAM wp, LPARAM lp)
{
...
// Ｖスクロール
bool Ccfg_wnd_modal_volume_bgmfade::on_v_scroll(WPARAM wp, LPARAM lp)
{
...
// スタティックコントロールのカラー変更
LRESULT Ccfg_wnd_modal_volume_bgmfade::on_ctlcolorstatic(WPARAM wp, LPARAM lp)
{
	LRESULT res;
